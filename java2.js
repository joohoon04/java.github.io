document.addEventListener('DOMContentLoaded', () => {
    ...
    // 벽돌 속성
    const brickRowCount = 5; // 벽돌의 행을 추가
    const brickColumnCount = 8; // 벽돌의 열을 추가
    const brickWidth = 100; // 벽돌의 너비를 100으로 설정
    const brickHeight = 70; // 벽돌의 높이를 30으로 설정
 ...
 function drawBricks() {
    ...
    function displayWinMessage() {
        ...
        setTimeout(() => {
            window.location.href = "index.html"; // 승리 메시지가 나타난 후 1초 후에 index 페이지로 이동
        }, 1000);
    }
